...
- [husky](https://typicode.github.io/husky)
  - See [`.husky`](https://github.com/tscstack/tscstack/blob/main/.husky) folder
- [lint-staged](https://github.com/okonet/lint-staged)
  - See [`.lintstagedrc`](https://github.com/tscstack/tscstack/blob/main/.lintstagedrc) file
- [commitlint](https://commitlint.js.org)
  - See [`.commitlint.config.mjs`](https://github.com/tscstack/tscstack/blob/main/commitlint.config.mjs) file
